...
import 'package:waste/Screens/Organization/OrganizationProfileEdit.dart';
    ...
    return isLoading
        ...
        : Scaffold(
            appBar: AppBar(
              ...
              elevation: 0,
              toolbarHeight: 90.0,
              titleTextStyle: const TextStyle(fontSize: 12.01),
              title: AppLogo(),
              centerTitle: true,
              actions: [
                TextButton(
                  ...
                  child: const Icon(Icons.edit,
                      size: 20.0, color: Color(0xff7FBD50), weight: 500),
                ),
              ],
            ),
            body: SafeArea(
