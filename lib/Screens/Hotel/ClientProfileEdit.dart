...
class HotelProfileEdit extends StatefulWidget {
  const HotelProfileEdit({Key? key}) : super(key: key);

  @override
  State<HotelProfileEdit> createState() => _HotelProfileEditState();
}

class _HotelProfileEditState extends State<HotelProfileEdit> {
    ...
    if (_formkey.currentState!.validate()) {
      try {
        ...
        FirebaseFirestore.instance.collection('users').doc(UserId).update({
          ...
          EasyLoading.dismiss();
          Navigator.push(
              context, MaterialPageRoute(builder: (context) => HotelProfile()));
        });
