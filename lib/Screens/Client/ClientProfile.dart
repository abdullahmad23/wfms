                  ...
                  child: Column(
                    ...
                    children: [
                                ...
                                crossAxisAlignment: CrossAxisAlignment.center,
                                  children: [
                                    ...
                                    Row(mainAxisAlignment: MainAxisAlignment.center,
                                      children: [
                                        Icon(Icons.mail_outline_rounded,color: Colors.white,),SizedBox(width: 5,),
                      ...
                      Container(padding: EdgeInsets.all(11),
                        ...
                        Text('Phone',style: TextStyle(fontSize: 22,fontWeight: FontWeight.w600),),
                      Text(UserDetails['phone']),

                      ],),
        ),
        ElevatedButton(style: ButtonStyle(backgroundColor: MaterialStateProperty.all(Color.fromARGB(255, 4, 32, 8)),
